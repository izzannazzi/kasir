          ...
          <div class="modal-body">
            <div class="">
                ...
                <?php
                    ...
                    ?>
                   <option value="<?= $id_produk ;?>"> <?= $nama_produk; ?> - <?= $deskripsi; ?>
                        
                    </option>
                    <?php
                    }
                    ?>
                    <input type="number" name="qty" class="form-control mt-2" placeholder="quantity" min="1" required>
